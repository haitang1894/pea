...
type Model = Pick<
  ...
  'id' | 'roleName' | 'roleCode' | 'roleDesc' | 'status' | 'createBy' | 'createTime' | 'updateBy' | 'updateTime'
>;
...
type RuleKey = Exclude<keyof Model, 'id' | 'roleDesc' | 'createBy' | 'createTime' | 'updateBy' | 'updateTime'>;
